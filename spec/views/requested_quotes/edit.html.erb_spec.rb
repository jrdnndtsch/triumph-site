...
RSpec.describe "requested_quotes/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit requested_quote form" do
    render

    assert_select "form[action=?][method=?]", requested_quote_path(@requested_quote), "post" do
